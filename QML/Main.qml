...
Window {
    ...
    property string profileImagePath: ":/assets/profilImage.png"
    ...
    property string visibilityIcon: "qrc:/assets/icons/visibility.svg"
    property string visibilityOffIcon: "qrc:/assets/icons/visibility_off.svg"
    ...
    function applyDateRange() {
        ...
        // Logika untuk memperbarui teks tombol sudah ditangani oleh UI lokal (modul)
        ...
        console.log("Date range applied:", rangeText);
    }
    ...
    Connections {
        target: deskmon
        function onShowAuthTokenErrorWindow(message) {
            tokenErrorWindow.errorMsg = message
            tokenErrorWindow.show()
        }
                ...
                RowLayout {
                    ...
                    Row {
                        ...
                        RoundButton {
                            ...
                            contentItem: Image {
                                source: window.Material.theme === Material.Dark ? "qrc:/assets/icons/light_mode.svg" : "qrc:/assets/icons/dark_mode.svg"
                                sourceSize.width: 24
                        ...
                        Button {
                            ...
                            contentItem: Item {
                                ...
                                Image {
                                    id: externalLinkIcon
                                    source: "qrc:/assets/icons/website.svg"
                                    sourceSize.width: 20
