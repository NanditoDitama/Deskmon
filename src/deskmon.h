...
public:
    explicit Deskmon(QObject *parent = nullptr);
    ~Deskmon();
    ...
    void logWindowChange(const WindowManager::WindowInfo &info, qint64 startTime, qint64 endTime);
    ...
    Q_INVOKABLE bool isTaskExpired(int taskId) const;
    ...
    // Notify helper
    void notify(const QString &type, const QString &message);
...
private:
    ...
    void sendProductivityAppToAPI(const QString &appName, const QString &windowTitle, const QString &url, int productivityType);
    ...
    WindowManager::WindowInfo getActiveWindowInfo();
    ...
    WindowManager::WindowInfo m_lastWindowInfo;
